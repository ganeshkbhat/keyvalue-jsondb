...
- <a name="runningserver">Running the Database Server</a>
  - <a name="runningserver">Running the DB Server with defaults</a>
  - <a name="runningserver">Running the DB Server with no username/password</a>
  - <a name="runningserver">Running the DB Server with username/password</a>
  - <a name="runningserver">Running the DB Server with with/without keys</a>
- <a name="runningshell">Running the Database Shell</a>
  - <a name="runningshell">Running the DB Shell with defaults</a>
  - <a name="runningshell">Running the DB Shell with no username/password</a>
  - <a name="runningshell">Running the DB Shell with username/password</a>
  - <a name="runningshell">Running the DB Shell with with/without keys</a>
- <a name="architecturedocs">Architecture Docs</a>
  - <a name="architecturedocs">Basic Design - Architecture of kvjsondb</a>
  - <a name="architecturedocs">kvjsondb Basic Storage</a>
- <a name="shellcommands">Shell Commands</a>
  - <a name="shellcommands">Shell Commands - Basic Usage</a>
